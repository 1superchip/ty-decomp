...
OSThread* OSSetIdleFunction(void (*idleFunc)(void*), void* param_1, void* param_2, u32 stackSize) {
    if (idleFunc != 0) {
        if (IdleThread.state == 0) {
            OSCreateThread(&IdleThread,(OSThreadStartFunction)idleFunc,param_1,param_2,stackSize,0x1f,1);
