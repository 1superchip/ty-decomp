...
asm long __ptmf_cmpr(register PTMF* ptmf, register PTMF* ptmf1) {
  nofralloc

  lwz r5, PTMF.this_delta(ptmf)
  lwz r6, PTMF.this_delta(ptmf1)
  lwz r7, PTMF.vtbl_offset(ptmf)
  lwz r8, PTMF.vtbl_offset(ptmf1)
  lwz r9, PTMF.func_data(ptmf)
  lwz r10, PTMF.func_data(ptmf1)
  li r3, 1
  cmpw cr0, r5, r6
  cmpw cr6, r7, r8
  cmpw cr7, r9, r10
